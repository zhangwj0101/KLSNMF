function Results = LSFTL(TrainX,TrainY,TestX,TestY,alpha,beta,numK,numCircle,base)
%%% 联合训练 列为一
G0 = [];
...
Results = tempRes;
csvwrite(strcat(base,'/LSF_Fs.csv'),bestFs);
csvwrite(strcat(base,'/LSF_Ss.csv'),bestSs);
csvwrite(strcat(base,'/LSF_Ft.csv'),bestFt);
csvwrite(strcat(base,'/LSF_St.csv'),bestSt);
csvwrite(strcat(base,'/LSF_G.csv'),bestGt);
