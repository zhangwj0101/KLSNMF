...
public class GetFWords {
    ...
    static String dicpath = "E:\\cls-acl10-processed_cutshortdoc\\mydata_add_withtraintest\\en_de_books_dvd\\dict.dat";
...
//        getTopWordsDTL(base);
    ...
    public static void getTopWordsLSFTL(String base) throws IOException {
        ...
        PrintStream ps = new PrintStream("G:\\毕业设计论文\\写论文\\journal\\" + base + "\\LSFTLs-TopWordt.txt");
    ...
    public static void getTopWordsTriTL(String base) throws IOException {
        ...
        List<String> dictsLists = FileUtils
                .readLines(new File(dicpath));
        List<String> indexLists = FileUtils
                .readLines(new File("F:\\matlab_code\\TriTL\\indext.csv"));
        Map<String, String> wordMaps = new HashMap<>();
        ...
        PrintStream ps = new PrintStream("G:\\毕业设计论文\\写论文\\journal\\" + base + "\\TRITLt-TopWords.txt");
        for (int li = 0; li < indexLists.size(); li++) {
            String[] split = indexLists.get(li).split(",");
            StringBuilder topWords = new StringBuilder();
            for (int i = 0; i < TOP_NUM; i++) {
    ...
    public static void getTopWordsDTL(String base) throws IOException {
        ...
        List<String> dictsLists = FileUtils
                .readLines(new File(dicpath));
        List<String> indexLists = FileUtils
                .readLines(new File("F:\\matlab_code\\DTL\\indexs.csv"));
        Map<String, String> wordMaps = new HashMap<>();
        ...
        PrintStream ps = new PrintStream("G:\\毕业设计论文\\写论文\\journal\\" + base + "\\DTLs-TopWords.txt");
        for (int li = 0; li < indexLists.size(); li++) {
            String[] split = indexLists.get(li).split(",");
            StringBuilder topWords = new StringBuilder();
            for (int i = 0; i < TOP_NUM; i++) {
